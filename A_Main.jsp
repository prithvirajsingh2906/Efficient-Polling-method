      ...
      <div class="sidebar">
        ...
        <div class="gadget">
          ...
          <ul class="sb_menu style2">
			...
			<li><a href="A_Add_Filter.jsp">Add Filter</a></li>
			<li><a href="A_View_All_Your_Polling.jsp">View All Friends Polling</a></li>
			<li><a href="A_View_Total_Pollings.jsp">View All Total Pollings</a></li>
			<li><a href="A_View_Positive_Negative_Pollings.jsp">View All Positive Negative Pollings</a></li>
			<li><a href="A_View_Polling_Results.jsp">View Polling Results</a></li>
			<li><a href="A_View_Polling_Rate_Results.jsp">View Polling Rate Results</a></li>
