        ...
        <div class="article">
           <h2><span class="style3">Search Friends And See Friend Requests</span></h2>
              ...
              <table width="551" cellpadding="0" cellspacing="0" align="center">
                    <tr>
                     <td bgcolor="#FFFF00"><a href="U_SearchFrd.jsp" class="style5" >1. Search Friends </a></td>
                     <td bgcolor="#FFFF00"><a href="U_FriendReq.jsp" class="style5" >2. Friend Requests </a></td>
                    </tr>
              </table>
