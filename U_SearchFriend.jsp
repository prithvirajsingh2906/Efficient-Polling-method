...
<%@ page import="java.text.SimpleDateFormat, java.util.Date"%>
		<%
			...
			<tr>
             ...
             <tr> <td width="105" height="80" valign="middle" bgcolor="#FF0000" style="color:#000000;"><div align="center" class="style7">Name</div></td>
			 <td width="90" height="80" valign="middle" bgcolor="#FF0000" style="color:#000000;"><div align="center" class="style4">&nbsp;&nbsp;
                 <%out.println(s1);%>
			 </div></td>
             </tr>
				   <tr>
				    <td width="105" height="26" valign="middle" bgcolor="#FF0000" style="color:#000000;"><div align="center" class="style7 style5"><strong>Status</strong></div></td>
              <%
						if(status.equals("Already Friend")){
						%>
              <td  width="90" height="26"align="center" valign="middle" bgcolor="#FF0000" style="color:#000000;"><span class="style7 style5"><strong><%=status %>&nbsp;</strong></span></td>
              <%
						}else if(status.equals("sent")){
						%>
              <td  width="57" height="26"align="center" valign="middle" bgcolor="#FF0000" style="color:#000000;"><span class="style7 style5"><strong><%=status %>&nbsp;</strong></span></td>
              <%
						}else{
						
						%>
              <td  width="107" height="26"align="center" valign="middle" bgcolor="#FF0000" style="color:#000000;"><a href="U_UpdateStatus.jsp?username=<%=s1%>&id=<%=i%>" class="style5"><strong><%=status %>&nbsp;</strong></a></td>
              <%}
						%>
            </tr>
            <%
